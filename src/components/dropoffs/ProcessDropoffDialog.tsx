      ...
      <DialogContent className="max-w-4xl sm:max-w-2xl w-full max-h-[95vh]">
        ...
        <div className="space-y-6 overflow-y-auto max-h-[calc(95vh-200px)] pr-2">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Select the tire type and enter quantity</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="space-y-2">
                <Label htmlFor="pte" className="flex items-center gap-2 text-base">
                  Passenger Tires
                </Label>
                <Input
                  id="pte"
              ...
              <div className="space-y-2">
                <Label htmlFor="otr" className="flex items-center gap-2 text-base">
                  OTR Tires
                </Label>
                <Input
                  id="otr"
              ...
              <div className="space-y-2">
                <Label htmlFor="tractor" className="flex items-center gap-2 text-base">
                  Semi Tires
                </Label>
                <Input
                  id="tractor"
